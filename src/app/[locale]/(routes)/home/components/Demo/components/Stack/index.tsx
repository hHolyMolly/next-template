  ...
  return (
    <div className="mx-auto flex max-w-[700px] flex-wrap justify-center gap-3">
      {items.map(({ name, color, icon }) => (
        <span
          key={name}
          className="inline-flex items-center gap-1.5 rounded-lg border border-white/[0.06] bg-white/[0.03] px-4 py-2.5 text-sm font-medium text-slate-200 transition-all duration-200 hover:border-white/10 hover:bg-white/[0.06]"
        >
