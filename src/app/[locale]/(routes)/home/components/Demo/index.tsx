...
export default function Demo({ languageSwitch }: DemoProps) {
  ...
  return (
    <section className="py-15 relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-slate-900 to-slate-950 px-6">
